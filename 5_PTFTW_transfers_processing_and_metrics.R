...
PTFTW_metrics_processed <- process_PTFTW_metrics(
  ...
  out_path = "../../GCCSmetricsII/Data_processing/5_PTFTW_processing_and_metrics/2025_10_20/PTFTW_new15_metrics.xlsx"
)
...
# process transfers_2019_2021 updated file, Add to function
...
# add crop strategy assignment, SG and CK assigned 2025_10_08
...
transfer_metrics <- transfers_metrics(
  croplist = "../../GCCSmetricsII/Data_processing/Support_files/GCCS_Selected_crops/croplist_new15crops.xlsx",
  out_path = "../../GCCSmetricsII/Data_processing/5_PTFTW_processing_and_metrics/2025_10_20/transfers_new15_metrics_2015_2021.xlsx",
